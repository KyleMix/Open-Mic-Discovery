...
| 5 | Cold-start deep link has no back stack or tabs | src/app/_layout.tsx | unstable_settings anchor (tabs) | done 03c7f0b |
...
| 10 | auth-callback spins forever for onboarded accounts | src/app/auth-callback.tsx | Navigate on successful exchange (returnTo or tabs); gate still runs the new-account funnel | in progress |
