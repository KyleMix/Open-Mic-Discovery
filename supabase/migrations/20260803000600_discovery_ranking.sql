-- Discovery ranking with teeth: paused listings leave the feed server-side,
-- and freshness finally affects order. Results sort by soonest night, then
-- freshness tier (fresh, aging, then stale or never confirmed), then
