...
//
// Serves the form on https://www.stonedgooseproductions.com/open-mics/delete-account, which works
...
const ALLOWED_ORIGIN = Deno.env.get('ALLOWED_ORIGIN') ?? 'https://www.stonedgooseproductions.com';
const PAGE_URL =
  Deno.env.get('DELETE_PAGE_URL') ??
