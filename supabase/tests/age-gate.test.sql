...
values ('00000000-0000-4000-a000-0000000000b1', 'age-gate@demo.openmic.local');
...
-- The latest EULA is 1.1 and it states the 18 requirement.
reset role;
select is(
  (select version from eula_versions order by published_at desc limit 1),
  '1.1', 'EULA 1.1 is the newest version'
);
select ok(
