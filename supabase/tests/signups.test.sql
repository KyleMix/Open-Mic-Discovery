...
insert into profiles (id, handle, display_name, stage_name, home_city, home_region,
  ...
  ('00000000-0000-4000-a000-000000000011', 'perf_two', 'Perf Two', 'Perf Two', 'Seattle', 'WA',
   true, '1.0', 'approved'),
  ('00000000-0000-4000-a000-000000000012', 'perf_three', 'Perf Three', 'Perf Three', 'Seattle', 'WA',
   true, '1.0', 'approved');
