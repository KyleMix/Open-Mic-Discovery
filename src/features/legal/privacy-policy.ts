...
/**
 * The in-app privacy policy. Shipped with the binary so it reads offline
 * and is reachable before an account exists (both stores require the
 * policy to be visible in-app, not only on a website). The hostable web
 * copy lives at docs/privacy/PRIVACY_POLICY.md and must say the same
 * things; update both together.
 */
...
- Profile: your stage name and handle (public), and optionally a bio, a profile photo, and links to your social accounts (public if you add them). A private name, if you set one, is visible only to you. Your birth year is collected once to confirm you meet the age requirement and is never public.
...
Questions about privacy or your data: ${SUPPORT_EMAIL}. A person reads it.
`;
